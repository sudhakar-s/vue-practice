<template>
  ...
  <RouterLink  v-if="!!to" :to :replace :class="rootClass">
    <component v-if="!!icon" :is="icon" size="medium" :color />
    <Text as="span" :weight :color>
      <slot />
    </Text>
  </RouterLink>
  <a v-else :href :target :rel :class="rootClass">
    <component v-if="!!icon" :is="icon" size="medium" :color />
    <Text as="span" :weight :color>
      <slot />
    </Text>
